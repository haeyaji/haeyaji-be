 ...
 * <p>필수 {@code text/lat/lng}. {@code userProfile}·{@code scheduleContext}는 be가 DB에서 조립해 실어보내며,
 * 미인증(프로필 없음) 요청에선 통째로 생략된다(NON_NULL). gap 필터는 nlp가 수행하므로 be는 {@code gapMinutes}만 정확히 넘긴다.
 */
