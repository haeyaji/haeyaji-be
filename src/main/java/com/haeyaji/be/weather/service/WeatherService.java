...
public class WeatherService {
    ...
    private final KmaNowcastClient nowcastProvider;
    private final KmaUltraForecastClient ultraForecastProvider;
    ...
    public WeatherService(KmaWeatherClient shortTermProvider,
                          KmaMidTermWeatherClient midTermProvider,
                          KmaNowcastClient nowcastProvider,
